...
# directory.
#
cd '/Users/elielr01/Documents/6to Semestre ITC/Calidad y Pruebas de Software/Dashboard/MetricasCalidad'

# Runs the Process Dashboard
#
java -Xmx800m -jar '/Users/elielr01/Documents/6to Semestre ITC/Calidad y Pruebas de Software/Dashboard/DashboardInstalacion/DashboardInstalacion/pspdash.jar' 'Process Dashboard'
